        ...
        if data_type.lower() == 'binary':
            ...
            for i in range(point_count):
                ...
                for j, field_name in enumerate(field_names):
                    field_size = field_sizes[j]
                    field_type = field_types[j]
                    field_count = field_counts[j]
                    ...
                    # Extract data
                    data_bytes = binary_data[offset + field_offset:offset + field_offset + field_size * field_count]
                    try:
                    ...
                    field_offset += field_size * field_count
...
def main():
    ...
    print("=" * 60)
    print("PCD to LAS Converter - With Normals Support")
    print("=" * 60)
    print()
